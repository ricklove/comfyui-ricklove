...
class ZoeDetector:
    ...
    def __call__(self, input_image, normMin, normMax):
...
class Zoe_Depth_Map_Preprocessor:
    ...
    def estimate_depth(self, image, normMin, normMax):
        ...
        for tensor_image in tensor_image_list:
            call_result = annotator_callback(resize_image(HWC3(tensor_image)), normMin, normMax)
